...
<html lang="en">
  ...
  <a href="/kisan-portal-main/index.php"
                ><img
                  style="height: 150px"
                  src="/kisan-portal-main/images/footer-logo.png"
                  alt="logo"
              /></a>
  ...
  <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="/kisan-portal-main/index.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <!-- <li class="nav-item">
      ...
      <li class="nav-item">
        ...
        <!-- <a class="nav-link" href="#" data-toggle="modal" data-target="#at-login" style="cursor: pointer;">Login</a> -->
      </li>
    </ul>
  </div>
</nav>
